...
class UnionOptional(
  ...
  override def get(index: Int): AnyRef = {
    index match {
      case 0 => return this.optionalField.getOrElse(null).asInstanceOf[AnyRef]
  ...
  object OptionalFieldUnionType {
    def decode(decoder: org.apache.avro.io.Decoder): MutableOptionalFieldUnionType = {
      decoder.readIndex() match {
        case 0 => decoder.readNull(); return MutableOptionalFieldUnionNull(null)
